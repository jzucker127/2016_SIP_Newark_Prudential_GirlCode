...
while not done:
    ...
    if keypressed == 1:
        ...
        message31 = font.render ("Our game ", 1, WHITE)
    ...
    if event.type == pygame.KEYDOWN:
        print(keypressed)
        if event.key == pygame.K_RIGHT and keypressed == 1:
            keypressed = 2
            
        elif event.key == pygame.K_RIGHT and keypressed == 2:
            keypressed = 3
            
        elif event.key == pygame.K_RIGHT and keypressed == 3:
            keypressed = 4
            
        elif event.key == pygame.K_RIGHT and keypressed == 4:
            keypressed = 5
            
        elif event.key == pygame.K_RIGHT and keypressed == 5:
            keypressed = 6
            
        elif event.key == pygame.K_RIGHT and keypressed == 6:
            keypressed = 7
            
        elif event.key == pygame.K_RIGHT and keypressed == 7:
            keypressed = 8
            
        elif event.key == pygame.K_RIGHT and keypressed == 8:
            keypressed = 9
            
        elif event.key == pygame.K_RIGHT and keypressed == 9:
            keypressed = 10
            
        elif event.key == pygame.K_RIGHT and keypressed == 10:
            keypressed = 11
            
        elif event.key == pygame.K_RIGHT and keypressed == 11:
            keypressed = 12
            
        elif event.key == pygame.K_RIGHT and keypressed == 12:
            keypressed = 13
            
        elif event.key == pygame.K_RIGHT and keypressed == 13:
            keypressed = 14
            
        elif event.key == pygame.K_RIGHT and keypressed == 14:
            keypressed = 15
            
        elif event.key == pygame.K_RIGHT and keypressed == 15:
            keypressed = 16
            
        elif event.key == pygame.K_RIGHT and keypressed == 16:
            keypressed = 17
            
        elif event.key == pygame.K_RIGHT and keypressed == 17:
            keypressed = 18
            
        elif event.key == pygame.K_RIGHT and keypressed == 18:
            keypressed = 19
